...
<h3>Licensing</h3>
<p>SlatePermutate is licensed under the terms of the GNU Affero General Public License, version 3. SlatePermutate is distributed without any warranty. See the <a href="http://www.gnu.org/licenses/" target="_blank">GNU Affero General Public License</a> for more details.</p>

<h3>Bug/Issue Tracking</h3>
<p>To view or file bugs for SlatePermutate, visit the <a href="http://protofusion.org/bugzilla/buglist.cgi?product=SlatePermutate">Bugzilla tracker</a> for the project. All issues will be addressed as soon as is reasonably possible.</p>

<h3>Source Code</h3>
<p>A beta version of SlatePermutate will be released in the coming weeks.</p>
...
<h3>About</h3>
<p>This program was created by <a href="http://www.calvin.edu" target="_blank">Calvin College</a> and <a href="http://cedarville.edu/" target="_blank">Cedarville University</a> students. SlatePermutate is written in PHP, with a valid XHTML frontend.</p>
